...
class RouterAgent:
    """
    Classifies user intent and extracts constraints and safety flags.
    """
...
Be conservative: mark "unsafe" intent_type if the user appears to ask for advice that could damage surfaces, pose respiratory risk, harm children, or break store or platform rules.
...
"""
    ...
    def _extract_json(self, text: str) -> Dict[str, Any]:
        ...
        if not match:
            raise ValueError("RouterAgent: no JSON found in model output")
